...
public:
     ...
     */
    virtual std::string coerceToString(const nix::Pos & pos, nix::NixStringContext & context, bool copyMore, bool copyToStore) const override
    {
     ...
     */
    virtual nlohmann::json printValueAsJSON(nix::EvalState & state, bool strict,
        nix::NixStringContext & context, bool copyToStore = true) const override
    {
     ...
     */
    virtual void printValueAsXML(nix::EvalState & state, bool strict, bool location,
        nix::XMLWriter & doc, nix::NixStringContext & context, nix::PathSet & drvsSeen,
        const nix::PosIdx pos) const override
    {
        ...
        nix_string_context ctx{context};
        desc.printValueAsXML((State*)&state, strict, location, &doc, &ctx, &drvsSeen, *reinterpret_cast<const uint32_t*>(&pos));
    }
