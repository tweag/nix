...
PrimOp *nix_alloc_primop(nix_c_context *, PrimOpFun fun, int arity,
...
Value *nix_get_list_byidx(nix_c_context *, const Value *value, unsigned int ix,
                          GCRef *ref);
Value *nix_get_attr_byname(nix_c_context *, const Value *value, State *state,
                           const char *name, GCRef *ref);

bool nix_has_attr_byname(nix_c_context *, const Value *value, State *state,
                         const char *name);

Value *nix_get_attr_byidx(nix_c_context *, const Value *value, State *state,
                          unsigned int i, const char **name, GCRef *ref);
...
nix_err nix_make_list(nix_c_context *, State *s, Value *value,
                      unsigned int size);
nix_err nix_set_list_byidx(nix_c_context *, Value *value, unsigned int ix,
                           Value *elem);
...
// owned ref
BindingsBuilder *nix_make_bindings_builder(nix_c_context *, State *state,
                                           size_t capacity);
nix_err nix_bindings_builder_insert(nix_c_context *, BindingsBuilder *b,
...
nix_err nix_external_add_string_context(nix_c_context *context,
                                        nix_string_context *ctx, const char *c);
