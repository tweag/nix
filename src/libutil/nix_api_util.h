 ...
 */
const char *nix_err_msg(nix_c_context *, const nix_c_context *,
                        unsigned int *n);

nix_err nix_err_info_msg(nix_c_context *, const nix_c_context *, char *value,
                         int n);

nix_err nix_err_name(nix_c_context *context, const nix_c_context *, char *value,
                     int n);
